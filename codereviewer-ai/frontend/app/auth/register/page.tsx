      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl animate-stagger-2">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Start reviewing code with AI in seconds</p>
          </div>
          ...
          {/* Sign In Link */}
          <p className="mt-6 text-center text-sm text-gray-400 animate-stagger-7">
        ...
        {/* Footer */}
        <div className="mt-8 text-center space-y-4 animate-stagger-8">
