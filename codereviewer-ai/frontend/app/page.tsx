      ...
      <div className="relative">
        ...
        <nav className="border-b border-white/10 backdrop-blur-sm sticky top-0 z-50 bg-black/50">
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-6 animate-stagger-2">
        ...
        <div className="max-w-7xl mx-auto px-6 pt-20 pb-16">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-sm mb-8 animate-stagger-1">
              <Sparkles className="w-4 h-4" />
              <span>Powered by Gemini 3</span>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-b from-white to-gray-500 animate-stagger-2">
              AI Code Review
              <br />
              That Actually Helps
            </h1>
            
            <p className="text-lg md:text-xl text-gray-400 mb-8 max-w-2xl mx-auto animate-stagger-3">
              Catch bugs, security issues, and performance problems before they hit production.
              Powered by Google's most advanced AI.
            </p>
            
            <div className="flex items-center gap-4 justify-center animate-stagger-4">
              <Link
                href="/auth/register"
            ...
            <p className="text-xs text-gray-600 mt-4 animate-stagger-5">
        ...
        <div id="demo" className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            {/* Right: Unified Animated Terminal */}
            <div className="animate-stagger-2">
              <UnifiedDemo />
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 animate-stagger-1">
              Built for performance
            </h2>
            <p className="text-gray-400 text-lg animate-stagger-2">
        ...
        <div className="max-w-7xl mx-auto px-6 py-24">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-500/10 via-purple-500/10 to-pink-500/10 border border-white/10 p-12 md:p-16 text-center animate-stagger-1">
